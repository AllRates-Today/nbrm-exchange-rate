// National Bank of North Macedonia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbrm';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'MKD', { apiKey }). */
